...
public class Main {
    ...
    private static final String DATA_FILE = "C:\\Users\\User\\Desktop\\Projects\\java_basics\\ExceptionsDebuggingAndTesting\\homework_2\\SPBMetro\\src\\main\\resources\\map.json";
    ...
    public static void main(String[] args) {
        ...
        loggerRoot = LogManager.getRootLogger();
        ...
        for (; ; )
            try {
                ...
                loggerExceptions.info("Unexpected error: " + e.toString());
            }
    }
