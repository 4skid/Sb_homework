...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (FileInputStream inputStream = new FileInputStream(pathTargetStations)) {
        ...
        stationsMap.forEach((o1, o2) -> System.out.println("Количество станций на линии №" + o1.concat(": ") + o2.size()));
    }
